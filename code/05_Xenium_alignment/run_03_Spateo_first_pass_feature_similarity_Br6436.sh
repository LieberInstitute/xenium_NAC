...
"${CONDA_ENV}/bin/python" "${SCRIPT_DIR}/03_Spateo_feature_similarity.py" \
    ...
    --aligned-coordinate-csv "${REPO_ROOT}/processed-data/05_Xenium_alignment/module01_Spateo_initial_pass_Br6436/Br6436_first_pass_coordinates.csv" \
    --output-dir "${REPO_ROOT}/processed-data/05_Xenium_alignment/module03_Spateo_feature_similarity_first_pass_Br6436" \
    --plot-dir "${REPO_ROOT}/plots/05_Xenium_alignment/module03_Spateo_feature_similarity_first_pass_Br6436" \
    --donor Br6436 \
    --donor-column Donor \
