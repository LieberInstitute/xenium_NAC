...
for value_col in ("prop", "fit"):
    ...
    for ct in sorted(top_ct):
        out_path = plot3d_outdir / f"Br6436_3d_{value_col}_{ct}.html"
...
for ct in sorted(fit_3d.keys()):
    plot_celltype_3d_heatmap(
        ...
        opacity=0.12,
        surface_count=30,
        save_path=volume_outdir / f"Br6436_3d_heatmap_{ct}.html",
    )
    print(f"  saved: {ct}\n")


### Parameter selection for Figure 2 panel C: 3D heatmap for D1_Island_A and D1_Island_B
sweep_outdir = plot_outdir / "3d_heatmap_sweep_d1_islands_Br6436"
...
for ct in ["D1_Island_A", "D1_Island_B", "Excitatory", "WM"]:
    plot_celltype_3d_heatmap_clean(
        ...
        opacity=0.12,
        surface_count=30,
        save_path=figure_outdir / f"Br6436_3d_heatmap_figure_{ct}.html",
    )
