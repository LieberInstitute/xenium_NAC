...
"${CONDA_ENV}/bin/python" "${SCRIPT_DIR}/05_Spateo_Xenium_VHD_second_pass.py" \
    ...
    --first-pass-coordinates "${REPO_ROOT}/processed-data/11_Xenium_VisiumHD_alignment/module_01_Spateo_first_pass/Br6660_NAc7_3580-VHD_H1_XKYDCP3_A1/Br6660_NAc7_3580-VHD_H1_XKYDCP3_A1_first_pass_coordinates.csv" \
    --device cuda \
    --max-iter 200 \
