...
# Fixed reference: Br6436_Nac_9_4650 (Xenium, 4650 um)
# Moving slice:    VHD_H1_XNQ4F2B_D1 (VisiumHD, 4630 um)
...
"${CONDA_ENV}/bin/python" "${SCRIPT_DIR}/05_Spateo_Xenium_VHD_second_pass.py" \
    --donor Br6436 \
    --xenium-sample Br6436_Nac_9_4650 \
    --vhd-sample VHD_H1_XNQ4F2B_D1 \
    --vhd-z-height 4630 \
    --realign-celltypes "${REALIGN_CELLTYPES[@]}" \
    --first-pass-coordinates "${REPO_ROOT}/processed-data/11_Xenium_VisiumHD_alignment/module_01_Spateo_first_pass/Br6436_Nac_9_4650-VHD_H1_XNQ4F2B_D1/Br6436_Nac_9_4650-VHD_H1_XNQ4F2B_D1_first_pass_coordinates.csv" \
    --device cuda \
    --max-iter 200 \
