...
# Run 4: fixed Br6660_NAc7_3580 (Xenium, 3580 um);
# moving VHD_H1_8MTH2TQ_D1 (VisiumHD, 3630 um).
...
"${CONDA_ENV}/bin/python" "${SCRIPT_DIR}/04_Spateo_Xenium_VHD_first_pass.py" \
    ...
    --vhd-h5ad "${REPO_ROOT}/processed-data/HD_Full_Analysis/h5ad/VHD_H1_8MTH2TQ_D1_spaceranger_square008um_spatial_um.h5ad" \
