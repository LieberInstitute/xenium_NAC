...
# Run 2: fixed Br6660_NAc6_3080 (Xenium, 3080 um);
# moving VHD_H1_M3TCP9V_A1 (VisiumHD, 3040 um).
...
"${CONDA_ENV}/bin/python" "${SCRIPT_DIR}/04_Spateo_Xenium_VHD_first_pass.py" \
    --donor Br6660 \
    --xenium-sample Br6660_NAc6_3080 \
    --vhd-sample VHD_H1_M3TCP9V_A1 \
    --vhd-z-height 3040 \
    ...
    --vhd-h5ad "${REPO_ROOT}/processed-data/HD_Full_Analysis/h5ad/VHD_H1_M3TCP9V_A1_spaceranger_square008um_spatial_um.h5ad" \
