...
# Fixed reference: Br6660_NAc4_2080 (Xenium, 2080 um)
# Moving slice:    VHD_H1_8MTH2TQ_A1 (VisiumHD, 2040 um)
...
"${CONDA_ENV}/bin/python" "${SCRIPT_DIR}/05_Spateo_Xenium_VHD_second_pass.py" \
    --donor Br6660 \
    --xenium-sample Br6660_NAc4_2080 \
    --vhd-sample VHD_H1_8MTH2TQ_A1 \
    --vhd-z-height 2040 \
    --realign-celltypes "${REALIGN_CELLTYPES[@]}" \
    --first-pass-coordinates "${REPO_ROOT}/processed-data/11_Xenium_VisiumHD_alignment/module_01_Spateo_first_pass/Br6660_NAc4_2080-VHD_H1_8MTH2TQ_A1/Br6660_NAc4_2080-VHD_H1_8MTH2TQ_A1_first_pass_coordinates.csv" \
    --device cuda \
    --max-iter 200 \
