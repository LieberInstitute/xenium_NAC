...
# Run 3: fixed Br6436_Nac_9_4650 (Xenium, 4650 um);
# moving VHD_H1_XNQ4F2B_D1 (VisiumHD, 4630 um).
...
"${CONDA_ENV}/bin/python" "${SCRIPT_DIR}/04_Spateo_Xenium_VHD_first_pass.py" \
    ...
    --vhd-h5ad "${REPO_ROOT}/processed-data/HD_Full_Analysis/h5ad/VHD_H1_XNQ4F2B_D1_spaceranger_square008um_spatial_um.h5ad" \
