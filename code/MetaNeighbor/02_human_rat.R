# Use metaneighbor to compare human and rat clusters
...
all_orthos <- intersect(rownames(rat_sce),shared_genes)
length(all_orthos) 
...
#Combine all objects
combo <- cbind(rat_sub,sce,spe_clean)
...
#Save the output
saveRDS(aurocs,file = here("processed-data","MetaNeighbor","Human_Both_rat_snRNA_Modalities_aurocs.Rds"))
