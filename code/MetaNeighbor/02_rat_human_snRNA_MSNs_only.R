...
rat_sce <- rat_sce[,rat_sce$ident %in% c("Drd1.1","Drd1.2","Drd2.1","Drd2.2","Drd3",,"Chst9","Sema5a",)]
...
pdf(file = here("plots","MetaNeighbor","MSNs_both_species.pdf"),width = 10, height = 12)
...
pdf(file = here("plots","MetaNeighbor","MSNs_cross_species.pdf"),width = 10, height = 12)
grid::grid.newpage()
