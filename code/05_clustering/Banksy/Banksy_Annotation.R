...
ann_df <- data.frame(Banksy_Cluster = c(1:15),
                     Annotation = c("MSN_A","WM_A","MSN_B",
                                    "WM_B","Endothelial","Excitatory",
                                    "WM_C","Microglia","D1_Island_A",
                                    "Inh_NPY_PNOC","Inh_CHAT","D1_Island_B",
                                    "Ependymal","WM_D","Immune"))
...
# D1_Island_A  D1_Island_B  Endothelial    Ependymal   Excitatory       Immune 
# 192707        60695       345006        56504       327998          144 
# Inh_CHAT Inh_NPY_PNOC    Microglia        MSN_A        MSN_B         WM_A 
# 114991       115127       219861      1245255       624322       645179 
# WM_B         WM_C         WM_D 
# 616903       295049        24434 
...
#Switch colors for some
cluster_cols["D1_Island_A"] <-  "#F87200" 
cluster_cols["WM_B"] <-  "#2AFECB"
cluster_cols["MSN_A"] <- "#1C8AE5"
cluster_cols["MSN_B"] <- "#FF001C"
cluster_cols["Immune"] <-  "#005345" 
cluster_cols["WM_A"] <-  "#aba8a4" 
...
# [1] "2025-07-16 18:22:28 EDT"
# user   system  elapsed 
# 367.760   13.511 2496.682 
# ─ Session info ──────────────────────────────────────────────────────────────────────────────────
# setting  value
