...
spe_joint <- clusterBanksy(spe_joint, use_agf = FALSE, lambda = 0,mclust.G = 20, algo =  "mclust",seed = 1000)
...
head(cluster_assign)
write.csv(cluster_assign,here("processed-data","05_Clustering","Banksy_Results","NonSpatial","mclust_Lambda0.csv"))
