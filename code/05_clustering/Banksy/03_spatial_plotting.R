...
for(i in c("clust_res0.25","clust_res0.50","clust_res0.75",
  ...
  new_dir_path <- here("plots","05_clustering","Banksy","Pre_Annotation","Spatial",i)
  ...
  saveRDS(cluster_cols,file = here("processed-data","05_Clustering","Banksy_Results","Spatial",paste0(i,"_spatial_colors.RDS")))
