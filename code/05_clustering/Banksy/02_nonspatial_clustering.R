...
#Read in the object
spe_joint <- readRDS(here("processed-data", "05_Clustering", "SPEs", "spe_joint_banksy_lambda_0.RDS"))
...
spe_joint <- clusterBanksy(spe_joint, use_agf = FALSE, lambda = 0, resolution = res, algo = "louvain",seed = 1000)
...
head(cluster_assign)
write.csv(cluster_assign,here("processed-data","05_Clustering","Banksy_Results","NonSpatial",paste0("Lambda0_res",res,"_louvain.csv")))
