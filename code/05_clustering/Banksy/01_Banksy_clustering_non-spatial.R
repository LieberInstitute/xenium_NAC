#Goal: Run Banksy spatial clustering with parameters equating to non-spatial clustering
...
#Save the object
saveRDS(spe_joint, here("processed-data", "05_Clustering", "SPEs", "spe_joint_banksy_lambda_0.RDS"))
