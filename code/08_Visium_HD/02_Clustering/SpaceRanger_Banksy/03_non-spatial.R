...
message("Assays after computeBanksy: ", paste(assayNames(sfe_list[[1]]), collapse = ", "))
...
sfe_joint <- runBanksyPCA(sfe_joint,use_agf = use_agf, lambda = lambda, group = "sample_id",seed = 1000) #Vignette uses seed of 1000
...
#Save the object
saveHDF5SummarizedExperiment(sfe_joint, here(
