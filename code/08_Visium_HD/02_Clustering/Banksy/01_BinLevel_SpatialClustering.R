...
#Find top 4000 HVGs and subset
top_hvgs <- getTopHVGs(modelGeneVar(spe), n = 2000)
spe <- spe[top_hvgs, ]
...
#Save the object
saveRDS(spe_joint, here("processed-data", "HD_Full_Analysis", "SPEs", "spe_bin_level_banksy_lambda_pt8.RDS"))
