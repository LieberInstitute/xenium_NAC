...
spe_path= "/dcs05/lieber/marmaypag/xenium_NAC_LIBD4125/xenium_NAC/processed-data/13_app/Xenium_spe.Rds"
...
spe_out <- here("processed-data", "14_samui", "spe.h5ad")
...
brnums <- unique(colData(spe)$Sample)
brnums <- as.character(brnums)
#sample_ids <- unique(colData(spe)$sample_id)
#sample_ids <- as.character(sample_ids)
writeLines(brnums, con = '/dcs05/lieber/marmaypag/xenium_NAC_LIBD4125/xenium_NAC/processed-data/14_samui/sample_list.txt')
#writeLines(sample_ids, con = '/dcs05/lieber/marmaypag/xenium_NAC_LIBD4125/xenium_NAC/processed-data/14_samui/sample_ids-xenium.txt')
